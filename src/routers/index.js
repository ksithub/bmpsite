  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path="/home-data-analysis" element={<HomeDataAnalysis />}/>
        ...
        <Route exact path="/help-center-single" element={<SingleHelpCenter />}/>
        ...
        <Route exact path="/integration-single" element={<IntegrationSingle />}/>
